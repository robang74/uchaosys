...
- download the pre-compiled self-extracting 32bit statoc binary from [here](https://github.com/robang74/working-in-progress/blob/main/uchaosys.qemu/umkaos32.gz.sh)
